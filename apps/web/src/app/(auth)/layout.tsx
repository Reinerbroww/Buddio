...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0f172a] text-slate-900 dark:text-slate-100 flex flex-col relative overflow-hidden transition-colors">
      ...
      <header className="sticky top-0 z-50 border-b border-slate-100 dark:border-[#334155] bg-white/80 dark:bg-[#0f172a]/80 backdrop-blur-md transition-colors">
