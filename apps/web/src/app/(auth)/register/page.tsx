  ...
  return (
    <div className="bg-white border border-slate-100 rounded-3xl shadow-xl shadow-slate-200/60 p-8 flex flex-col gap-6">
      <div className="text-center space-y-2">
        ...
        <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Buat akun Buddio</h1>
        <p className="text-xs text-slate-500">Mulai belajar dengan mentor AI yang paham levelmu.</p>
      </div>
