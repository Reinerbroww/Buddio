...
class BuddioAI:
    ...
    def generate_lesson(
        ...
        prompt = (
            ...
            "UNTUK VIDEOS:\n"
            "Cari dan masukkan 3-4 video YouTube yang RELEVAN dengan topik ini. "
            "URL HARUS berupa link langsung ke video, contoh: https://www.youtube.com/watch?v=VIDEO_ID\n"
            "JANGAN gunakan URL pencarian (search_results). "
            "Jika tidak yakin video spesifik, buatlah URL pencarian dengan query yang tepat: "
            "https://www.youtube.com/results?search_query=kata+kunci+pencarian\n"
            "Pastikan setiap video memiliki judul yang deskriptif dan deskripsi singkat.\n\n"
