...
class BuddioAI:
    ...
    def generate_lesson(
        ...
        prompt = (
            f"Buatkan materi pembelajaran LENGKAP dan MENARIK untuk langkah belajar \"{step_title}\" "
            ...
            "  ]\n"
            "}\n\n"
            "===== ATURAN PENTING UNTUK CONTENT =====\n\n"
            "Gunakan BAHASA INDONESIA yang ASIK, ENGAGING, dan MUDAH DIPAHAMI. "
            "Bayangkan kamu sedang menjelaskan ke teman sekelas yang lagi ngantuk!\n\n"
            "STRUKTUR MATERI WAJIB:\n\n"
            "1. **Pembukaan menarik** — Mulai dengan pertanyaan pemantik, fakta unik, atau analogi kehidupan sehari-hari.\n\n"
            "2. **Penjelasan Konsep** — Jelaskan dengan analogi dan contoh nyata. "
            "Gunakan simbol-simbol khusus berikut untuk callout box:\n"
            "   - [!tip] = Kotak saran/tips berguna (gunakan untuk tips belajar)\n"
            "   - [!funfact] = Fakta menarik yang bikin kaget\n"
            "   - [!ingat] = Poin penting yang WAJIB diingat\n"
            "   - [!contoh] = Contoh konkret langkah demi langkah\n"
            "   - [!perhatian] = Hal yang sering salah atau traps\n"
            "   - [!quiz] = Mini quiz untuk self-check\n\n"
            "3. **Poin-Poin Penting** — Bullet points dengan istilah penting.\n\n"
            "4. **Contoh** — 2-3 contoh konkret. Gunakan [!contoh] untuk setiap contoh.\n\n"
            "5. **Latihan Mandiri** — 2-3 soal dengan jawaban tersembunyi (tulis 'Klik untuk melihat jawaban' sebagai pemisah). "
            "Gunakan [!quiz] untuk soal-soal ini.\n\n"
            "6. **Ringkasan** — Rangkum dalam poin-poin singkat. "
            "Gunakan [!ingat] untuk poin yang paling krusial.\n\n"
            "7. **Penutup motivasi** — Satu kalimat penyemangat!\n\n"
            "GAYA PENULISAN:\n"
            "- Gunakan analogi sehari-hari (misal: 'Bayangin seperti GPS untuk otakmu')\n"
            "- Sesekali gunakan humor ringan yang relevan\n"
            "- Break down konsep sulit jadi langkah-langkah kecil\n"
            "- Gunakan bold untuk istilah penting\n"
            "- Buat pembaca merasa 'oh gitu toh, gampang ya!'\n\n"
            "UNTUK VIDEOS:\n"
            "Cari dan masukkan 3-4 video YouTube yang RELEVAN. "
            "URL: https://www.youtube.com/watch?v=VIDEO_ID (bukan search URL). "
            "Jika tidak yakin, gunakan: https://www.youtube.com/results?search_query=kata+kunci\n\n"
            "Sesuaikan kedalaman materi dengan jenjang: "
            f"{grade_level or 'sma'}."
        )

        lesson_sys_prompt = (
            "Kamu adalah Buddio, mentor belajar AI yang SERU, SUPPORTIF, dan JAGO "
            "menjelaskan materi dengan cara yang FUN dan ENGAGING. "
            "Gaya bahasamu seperti kakak kelas yang pintar dan asik diajak ngobrol. "
            "Kamu selalu pakai analogi keren, fakta unik, dan bikin belajar jadi menyenangkan. "
            "Bahasa Indonesia yang santai tapi tetap edukatif."
        )
