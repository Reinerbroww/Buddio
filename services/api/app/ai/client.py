...
class BuddioAI:
    ...
    def generate_lesson(
        ...
        prompt = (
            ...
            " VIDEO YOUTUBE\n"
            "=================================================================\n\n"
            "Sertakan 2-3 video YouTube yang RELEVAN.\n"
            "URL format: https://www.youtube.com/watch?v=VIDEO_ID (bukan search URL)\n"
            "Jika tidak yakin dengan ID spesifik, gunakan:\n"
            "https://www.youtube.com/results?search_query=kata+kunci+yang+relevan\n\n"
