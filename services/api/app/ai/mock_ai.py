...
def mock_lesson(step_title: str, topic_title: str) -> dict:
    return {
        "content": (
            ...
            f"Atau analogi lain: seperti level pertama di game. Kalau level 1 aja belum "
            f"lulus, jangan harap bisa lawan bos di level 10. {step_title} itu level 1-mu. "
            f"Dan tenang, nggak ada yang namanya \"game over\" di sini — bisa diulang terus! 🎮\n\n"
            ...
            f"> - [ ] menjelaskan kenapa {step_title} nggak bisa dilewati kalau mau jago {topic_title}\n\n"

            f"---\n\n"

            f"### Memahami {step_title} dari Nol\n\n"
            f"Sebelum kita masuk ke penjelasan teknis, coba pahami analogi ini:\n\n"
            f"**Analogi LEGO:** Bayangkan kamu sedang merakit LEGO. {step_title} itu seperti "
            ...
            f"**Analogi Masakan:** Atau kalau kamu suka masak, {step_title} itu seperti "
            f"garam — kelihatannya remeh, tapi tanpa garam, makanan terasa hambar. "
            f"Nggak ada yang mau makan nasi tanpa garam, kan? 🧂\n\n"
            ...
            f">\n"
            f"> **Bonus:** Coba jelaskan ke kucing, anjing, atau bantal di kamar kamu. "
            f"Kalau bantalnya bisa \"mengerti\", berarti penjelasanmu udah oke. 🐱\n\n"
            ...
            f"Nggak perlu panik kalau ada istilah yang asing. Ingat: semua orang pernah "
            f"jadi pemula. Bahkan Einstein dulu juga pernah bingung nonton orang berpidato "
            f"tanpa ngerti satu kata pun. 😄\n\n"
            ...
            f"Intinya: ada masalah → ada cara kerja → ada solusi. Sesederhana itu! "
            f"Jangan bikin rumit di kepala dulu.\n\n"
            ...
            f">\n"
            f"> Analoginya seperti belajar berenang: kamu bisa baca teori tentang "
            f"gaya bebas seharian, tapi tetap aja harus masuk kolam untuk bisa berenang! 🏊\n\n"
            ...
            f">\n"
            f"> Simple, kan? Sekarang coba pikirkan: bisa kamu memberikan contoh lain "
            f"yang mirip dari kehidupan sehari-hari? Kalau bisa, berarti pemahamanmu udah kuat!\n\n"
            ...
            f">\n"
            f"> Ini namanya \"teknik Feynman\" — dinamai dari fisikawan Richard Feynman "
            f"yang terkenal bisa menjelaskan hal rumit dengan bahasa sederhana. Kalau dia bisa, "
            f"kamu juga bisa! 🧪\n\n"
            ...
            f">\n"
            f"> Koneksi antar konsep itu powerful banget. Otak kita lebih mudah mengingat "
            f"sesuatu yang dihubungkan dengan hal yang sudah dikenal. Makanya analogi itu "
            f"penting! 🧠\n\n"

            f"---\n\n"

            f"### Mitos vs Fakta\n\n"
            f"Ada beberapa kesalahpahaman umum tentang {step_title} yang bikin orang "
            f"salah langkah. Yuk kita bongkar satu per satu!\n\n"

            f"> [!perhatian]\n"
            f"> **Mitos 1:** \"{step_title} itu cuma teori, nggak penting banget\"\n"
            f"> **Fakta:** {step_title} adalah fondasi — tanpa ini, materi lanjutan "
            f"akan jauh lebih sulit. Ibarat mau bangun rumah lantai 3 tapi fondasi "
            f"lantai 1 belum jadi. Ya goyang dong! 🏗️\n\n"

            f"> [!perhatian]\n"
            f"> **Mitos 2:** \"Cukup hafalin definisinya\"\n"
            f"> **Fakta:** Menghafal definisi tanpa memahami maknanya itu seperti "
            f"punya GPS tapi nggak tau mau ke mana — alatnya ada, tapi nggak berguna. "
            f"Coba jelaskan dengan bahasamu sendiri. Kalau bisa dijelaskan, berarti sudah dipahami.\n\n"

            f"> [!perhatian]\n"
            f"> **Mitos 3:** \"Kalau nggak langsung paham, berarti emang nggak bakat\"\n"
            f"> **Fakta:** Nggak ada yang namanya \"nggak bakat\". Yang ada adalah "
            f"\"belum cukup latihan\". Semua orang bisa paham {step_title} — "
            f"butuh waktu, kesabaran, dan latihan yang konsisten. Jangan menyerah! 💪\n\n"
            ...
            f"> - Praktik lebih penting dari sekadar membaca teori\n"
            f"> - Kalau stuck, coba jelaskan ke orang lain (atau ke bantal!)\n\n"
            ...
            f">\n"
            f"> **Soal 4 — Tantangan (Bonus):**\n"
            f"> Coba bandingkan {step_title} dengan konsep lain yang mirip "
            f"dalam {topic_title}. Apa persamaan dan perbedaannya?\n\n"
            ...
            f"4. [Bonus!] Kalau bisa menjawab ini, berarti pemahamanmu udah "
            f"level lanjut. Good job! 🌟\n\n"
            ...
            f"Kalau ada yang masih kurang jelas, jangan sungkan untuk "
